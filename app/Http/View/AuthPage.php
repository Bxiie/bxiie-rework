...
<div class="sso-row">
    <a class="button secondary oauth-button oauth-button-google" href="{$googleHref}"><span class="oauth-provider-icon oauth-provider-icon-google" aria-hidden="true"><svg viewBox="0 0 18 18" focusable="false"><path fill="#4285F4" d="M17.64 9.205c0-.638-.057-1.252-.164-1.841H9v3.482h4.844a4.14 4.14 0 0 1-1.797 2.715v2.258h2.909c1.702-1.567 2.684-3.878 2.684-6.614Z"/><path fill="#34A853" d="M9 18c2.43 0 4.468-.806 5.956-2.181l-2.909-2.258c-.806.54-1.835.859-3.047.859-2.344 0-4.328-1.585-5.037-3.714H.956v2.332A9 9 0 0 0 9 18Z"/><path fill="#FBBC05" d="M3.963 10.706A5.41 5.41 0 0 1 3.682 9c0-.592.102-1.167.281-1.706V4.962H.956A9 9 0 0 0 0 9c0 1.452.347 2.827.956 4.038l3.007-2.332Z"/><path fill="#EA4335" d="M9 3.58c1.321 0 2.507.454 3.44 1.346l2.581-2.581C13.464.892 11.426 0 9 0A9 9 0 0 0 .956 4.962l3.007 2.332C4.672 5.165 6.656 3.58 9 3.58Z"/></svg></span><span><span class="oauth-provider-mark oauth-provider-mark-google" aria-hidden="true"><svg viewBox="0 0 24 24" focusable="false"><path fill="#4285F4" d="M21.6 12.23c0-.71-.06-1.24-.2-1.79H12v3.39h5.52a4.71 4.71 0 0 1-2.05 3.09v2.2h3.32c1.94-1.79 3.06-4.42 3.06-7.89z"/><path fill="#34A853" d="M12 22c2.77 0 5.1-.91 6.79-2.47l-3.32-2.61c-.92.62-2.1.99-3.47.99-2.67 0-4.94-1.81-5.75-4.24H2.82v2.27A10.25 10.25 0 0 0 12 22z"/><path fill="#FBBC05" d="M6.25 13.67A6.16 6.16 0 0 1 5.93 12c0-.58.11-1.14.32-1.67V8.06H2.82A10.05 10.05 0 0 0 1.75 12c0 1.42.38 2.77 1.07 3.94l3.43-2.27z"/><path fill="#EA4335" d="M12 6.09c1.51 0 2.87.52 3.94 1.54l2.95-2.95C17.1 3.02 14.77 2 12 2a10.25 10.25 0 0 0-9.18 6.06l3.43 2.27C7.06 7.9 9.33 6.09 12 6.09z"/></svg></span><span class="oauth-provider-label">Continue with Google</span></span></a>
    <a class="button secondary oauth-button oauth-button-facebook" href="{$facebookHref}"><span class="oauth-provider-icon oauth-provider-icon-facebook" aria-hidden="true"><svg viewBox="0 0 18 18" focusable="false"><circle cx="9" cy="9" r="9" fill="#1877F2"/><path fill="#fff" d="M10.5 15v-5h1.68l.252-1.96H10.5V6.79c0-.567.157-.953.97-.953h1.036V4.084A13.89 13.89 0 0 0 10.996 4C9.5 4 8.476 4.913 8.476 6.59v1.45H6.783V10h1.693v5H10.5Z"/></svg></span><span><span class="oauth-provider-mark oauth-provider-mark-facebook" aria-hidden="true"><svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="11" fill="#1877F2"/><path fill="#fff" d="M13.6 20v-7h2.35l.35-2.73H13.6V8.53c0-.79.22-1.33 1.36-1.33h1.45V4.76a19.4 19.4 0 0 0-2.11-.11c-2.09 0-3.52 1.28-3.52 3.62v2H8.42V13h2.36v7h2.82z"/></svg></span><span class="oauth-provider-label">Continue with Facebook</span></span></a>
</div>
