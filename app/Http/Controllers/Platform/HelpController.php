...
HTML,
            ...
            'artwork-publishing' => [
                'title' => 'Bulk upload and website releases',
                'body' => <<<'HTML'
<p>Use these tools when you need to add many artworks or make a coordinated body of work public at a specific time. Website publication and Instagram publication are separate: Release Groups change artwork visibility on your ArtsFolio site and never create Instagram posts.</p>
<h2>Bulk upload a directory</h2><ol class="flow-list compact"><li><strong>Open Artworks.</strong><span>Choose <strong>Bulk upload</strong> from the artwork actions.</span></li><li><strong>Download the sample.</strong><span>Use the sample CSV as the starting point so column names and date formatting remain valid.</span></li><li><strong>Prepare one directory.</strong><span>Put <code>artworks.csv</code> and every referenced image in the same selected directory. Each filename may appear only once.</span></li><li><strong>Choose the directory.</strong><span>Submit the directory and review the result page. Rows with validation errors are listed separately.</span></li><li><strong>Inspect imported artwork.</strong><span>Open the Artworks grid and verify images, metadata, sections, types, sale status, and publication state.</span></li></ol>
<h2>Schedule one artwork</h2><ol class="flow-list compact"><li><strong>Edit the artwork.</strong><span>Open the artwork from the Artworks page and find Website publication.</span></li><li><strong>Enter the local date and time.</strong><span>The form shows which timezone ArtsFolio will use. Leave Release Group set to No release group.</span></li><li><strong>Save the artwork.</strong><span>The scheduled time then appears in the Artworks grid. The background worker publishes the artwork when it becomes due.</span></li></ol>
<h2>Create a Release Group</h2><ol class="flow-list compact"><li><strong>Name the group.</strong><span>Use a recognizable release name.</span></li><li><strong>Select artwork.</strong><span>Assign draft images from the Release Group page, or select the group under Website publication while editing an artwork.</span></li><li><strong>Schedule the release.</strong><span>Set the website release date and time on the Release Group, then save.</span></li><li><strong>Review before launch.</strong><span>Confirm the group count, status, schedule, and selected artwork. At the scheduled time, all non-archived artwork in the group is published.</span></li></ol>
<h2>CSV scheduling rules</h2><ul class="link-list"><li>Use <code>publish_at</code> for an individual website publication time in <code>YYYY-MM-DD HH:MM</code> format.</li><li>Use <code>release_group</code> to assign an image to a named group, then schedule the group in admin.</li><li>Do not use <code>publish_at</code> and <code>release_group</code> in the same row.</li><li>Separate multiple section names or artwork type codes with a vertical bar (<code>|</code>).</li></ul>
HTML,
            ],
            'instagram-publishing' => [
                'title' => 'Instagram publishing',
                'body' => <<<'HTML'
<p>Instagram publishing is included with Studio, Professional, and Collective. ArtsFolio uses one platform-owned Meta application; you connect your own Instagram Creator or Business account without creating a Meta app.</p>
<h2>Connect Instagram</h2><ol class="flow-list compact"><li><strong>Confirm the account type.</strong><span>Your Instagram account must be a Creator or Business account.</span></li><li><strong>Open Instagram.</strong><span>Go to <strong>Instagram</strong> in your admin area and choose <strong>Connect Instagram</strong>.</span></li><li><strong>Authorize the correct account.</strong><span>Complete Meta's authorization flow and verify the username shown when you return.</span></li></ol>
<h2>Create a post</h2><ol class="flow-list compact"><li><strong>Start from an artwork.</strong><span>Use <strong>Post to Instagram</strong> on the Artworks page or public artwork page.</span></li><li><strong>Review the warning.</strong><span>If ArtsFolio says the image was shared before, decide whether another post is intentional.</span></li><li><strong>Edit caption and hashtags.</strong><span>ArtsFolio deduplicates hashtags before saving. Private notes are never added to the post.</span></li><li><strong>Choose carousel images.</strong><span>Expand carousel settings only when needed, select up to ten images, order them, and choose crop behavior.</span></li><li><strong>Publish or schedule.</strong><span>Use <strong>Post Now</strong> for immediate publication or provide a date and time before choosing <strong>Schedule Post</strong>.</span></li></ol>
<h2>Confirm publication</h2><p>After submission, check the visible status message and the Instagram history table. Publishing happens through the background worker and may take a short time. A published row includes an Instagram link when Meta provides one.</p>
<h2>Troubleshooting</h2><ul class="link-list"><li><strong>Authorization required.</strong> Reconnect the same Instagram account from the Instagram admin page.</li><li><strong>Invalid redirect URI.</strong> The production callback configured in Meta must exactly match the ArtsFolio callback.</li><li><strong>Failed post.</strong> Read the error beneath the history status. Do not repeatedly click Post Now while a submission is queued or publishing.</li><li><strong>Wrong account.</strong> Verify the username before posting. Existing scheduled posts remain bound to the account originally selected.</li></ul>
HTML,
            ],
            'branding' => [
...
HTML,
            ...
            'training-videos' => [
                ...
                'body' => <<<'HTML'
<p>These ArtsFolio training videos are published on the official <a href="https://www.youtube.com/channel/UCIk07bDUEGg-lXNaYiaH4ig" target="_blank" rel="noopener">ArtsFolio Training YouTube channel</a>. Use the written guide beside each video while working in another tab.</p><h2>Video directory</h2><ul class="link-list"><li><strong>01. Admin Orientation.</strong> <a href="https://www.youtube.com/watch?v=Qj_PFrHNWvQ" target="_blank" rel="noopener">Watch video 01</a>. Written guide: <a href="/help/new-admin-tour">new-admin setup tour</a>.</li><li><strong>02. Site Identity, Branding, and Content.</strong> <a href="https://www.youtube.com/watch?v=Z4XHLpUxCFk" target="_blank" rel="noopener">Watch video 02</a>. Written guide: <a href="/help/branding">branding</a>.</li><li><strong>03. Artwork Upload and Portfolio Structure.</strong> <a href="https://www.youtube.com/channel/UCIk07bDUEGg-lXNaYiaH4ig/videos" target="_blank" rel="noopener">Find video 03 on the channel</a>. Written guide: <a href="/help/artworks">artwork management</a>.</li><li><strong>04. Events and Public History.</strong> <a href="https://www.youtube.com/watch?v=xFSaqWzGWYI" target="_blank" rel="noopener">Watch video 04</a>. Written guide: <a href="/help/events">events</a>.</li><li><strong>05. Messages and Email Signups.</strong> <a href="https://www.youtube.com/watch?v=3cPqM9qbe34" target="_blank" rel="noopener">Watch video 05</a>. Written guide: <a href="/help/messages-email">messages and email signups</a>.</li><li><strong>06. Sales, Orders, Analytics, and Refunds.</strong> <a href="https://www.youtube.com/channel/UCIk07bDUEGg-lXNaYiaH4ig/videos" target="_blank" rel="noopener">Find video 06 on the channel</a>. Written guide: <a href="/help/sales">sales</a>.</li></ul><p><a class="button" href="https://www.youtube.com/channel/UCIk07bDUEGg-lXNaYiaH4ig/videos" target="_blank" rel="noopener">Open all ArtsFolio training videos</a></p>
HTML,
            ],
        ];
    }
...
HTML;
    ...
    private function nav(string $active, bool $loggedIn): string
    {
        $items = [
            ...
            'artwork-publishing' => ['/help/artwork-publishing', 'Bulk upload and releases'],
            'instagram-publishing' => ['/help/instagram-publishing', 'Instagram publishing'],
