    ...
    public function __construct()
    {
        $this->articles = [
            'getting-started' => [
                ...
                'body' => <<<'HTML'
<p>ArtsFolio gives a tenant admin one place to build and operate an artist website: public pages, portfolio records, events, contact messages, email signups, sales, analytics, directory discovery, users, domains, and billing. The safest first goal is a small, complete, believable site that can be reviewed on a phone and shared with a collector.</p>
<h2>Before you start</h2><ul class="link-list"><li><strong>Use the tenant domain for tenant work.</strong> Open <code>/admin</code> on the artist site, for example <code>https://example.com/admin</code>. Platform-wide administration is not used for normal site editing.</li><li><strong>Save in small batches.</strong> Change one area, save it, open the public page, and confirm the result before moving on.</li><li><strong>Keep a launch checklist.</strong> A site is ready to share when it has identity, About, Contact, at least one section, several published artworks, mobile review, contact testing, and stats visibility.</li></ul>
<h2>Recommended first build</h2><ol class="flow-list compact"><li><strong>Open tenant admin.</strong><span>Sign in and open <code>/admin</code>. The dashboard points to messages, sales, stats, settings, artwork, events, and setup help.</span></li><li><strong>Set site identity.</strong><span>Open <code>/admin/settings</code>. Confirm site name, public labels, titles, typography, palette, logo, watermark behavior, and visibility.</span></li><li><strong>Write About and Contact.</strong><span>Open <code>/admin/content</code>. Add a clear About statement, practical Contact text, and selected site images.</span></li><li><strong>Create sections.</strong><span>Open <code>/admin/portfolio-sections</code>. Create broad visitor-friendly groups such as Sculpture, Paintings, Installations, Available Work, or Archive.</span></li><li><strong>Add artwork.</strong><span>Use <code>/admin/artwork/upload</code>. Add image, title, year, medium, dimensions, description, status, sale status, price, inventory, and sections.</span></li><li><strong>Curate the public experience.</strong><span>Use <code>/admin/curation</code> and the Artworks grid to decide what appears first.</span></li><li><strong>Add events.</strong><span>Use <code>/admin/events</code> for exhibitions, open studios, fairs, talks, installations, residencies, and public history.</span></li><li><strong>Test visitor paths.</strong><span>Open homepage, portfolio, artwork details, About, Contact, email signup, cart if enabled, and mobile layout.</span></li><li><strong>Review operations.</strong><span>Check <code>/admin/contact-messages</code>, <code>/admin/email-signups</code>, <code>/admin/stats</code>, <code>/admin/audit-log</code>, and <code>/admin/routes</code>.</span></li></ol>
