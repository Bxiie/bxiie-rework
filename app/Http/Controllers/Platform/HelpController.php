...
<h2>Schedule one artwork</h2><ol class="flow-list compact"><li><strong>Open Release Groups &amp; scheduling.</strong><span>Choose the draft artwork from the individual scheduling form.</span></li><li><strong>Enter the local date and time.</strong><span>The form shows which timezone ArtsFolio will use.</span></li><li><strong>Save the schedule.</strong><span>The scheduled time then appears in the Artworks grid. The background worker publishes the artwork when it becomes due.</span></li></ol>
<h2>Create a Release Group</h2><ol class="flow-list compact"><li><strong>Name the group.</strong><span>Use a recognizable release name.</span></li><li><strong>Select artwork.</strong><span>Assign the draft images that should become public together.</span></li><li><strong>Schedule the release.</strong><span>Set the website release date and time, then save.</span></li><li><strong>Review before launch.</strong><span>Confirm the group count, status, schedule, and selected artwork. At the scheduled time, all non-archived artwork in the group is published.</span></li></ol>
