...
final class EmailTemplateCatalog
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'platform/tenant-signup-invite-no-free-period.txt' => ['description' => 'Invitation for a signup code that provides no complimentary access; paid plans proceed to Stripe during signup.', 'keys' => ['platform.tenant_signup_invite.no_free_period']],
            'platform/tenant-signup-invite-one-month.txt' => ['description' => 'Invitation for a signup code that provides exactly one complimentary month.', 'keys' => ['platform.tenant_signup_invite.one_month']],
            'platform/tenant-signup-invite.txt' => ['description' => 'Invitation for a signup code that provides two or more complimentary months.', 'keys' => ['platform.tenant_signup_invite.multiple_months', 'platform.tenant_signup_invite']],
