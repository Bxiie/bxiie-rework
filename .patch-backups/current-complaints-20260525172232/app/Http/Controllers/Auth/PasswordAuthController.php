...
final class PasswordAuthController
{
    ...
    {
        return Response::html(AuthPage::login('/login/password', csrfToken: $this->csrf->getOrCreate()));
    }

    public function loginPassword(Request $request): Response
    {
        // Accept both the branded /login/password route and legacy /login form posts.
    ...
    public function me(Request $request, ?array $currentUser): Response
    {
        ...
        $nameLine = $displayName !== '' ? '<p><strong>Name:</strong> ' . $displayName . '</p>' : '';
...
<head>
    <meta charset="utf-8">
    <title>Your Account | ArtsFolio</title>
...
<main class="auth-page">
    <section class="auth-card">
        ...
        <h1>Your ArtsFolio account</h1>
        <p class="auth-copy">This page confirms your platform identity. Tenant administration lives on the artist site domain at <code>/admin</code>; platform administration lives at <code>/admin</code> on artsfol.io for platform staff.</p>
        <div class="admin-panel">
            <p><strong>Email:</strong> {$email}</p>
            {$nameLine}
        </div>
        <p class="auth-links"><a href="/admin">Open admin</a><a href="/help">Help</a><a href="/directory">Artist directory</a></p>
