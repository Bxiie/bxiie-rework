...
<table>
  <tr><th>Received</th><th>Name</th><th>Email</th><th>Message</th><th>Actions</th></tr>
  <?php foreach ($messages as $message): ?>
    <tr>
      ...
      <td>
        <form method="post" action="/admin/messages/delete" onsubmit="return confirm('Delete this contact message?');">
