...
$mustContain = [
    ...
    [$tenantLayout, 'tenant-admin.css?v=20260623-sidebar-upload', 'Tenant admin CSS cache busts palette button styling'],
    [$platformLayout, 'tenant-admin.css?v=20260623-sidebar-upload', 'Platform admin CSS cache busts palette button styling'],
