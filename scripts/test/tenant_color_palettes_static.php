...
$mustContain = [
    ...
    [$script, '.tenant-palette-button[data-tenant-palette]', 'Admin color script binds palette buttons'],
    [$script, "dispatchEvent(new Event('input'", 'Palette application updates enhanced color fields'],
