...
$mustContain = [
    ...
    [$tenantLayout, 'tenant-admin.css', 'Tenant admin CSS cache busts palette button styling'],
    [$platformLayout, 'tenant-admin.css', 'Platform admin CSS cache busts palette button styling'],
