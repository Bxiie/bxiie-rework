...
$mustContain = [
    ...
    [$settingsController, 'font_size_body', 'Body font size rendered'],
    [$settingsController, 'font_size_heading', 'Heading font size rendered'],
    [$settingsController, 'font_size_subheading', 'Subheading font size rendered'],
    [$settingsController, 'font_size_brand', 'Site title font size rendered'],
    [$settingsController, 'font_size_nav', 'Navigation font size rendered'],
    [$settingsController, 'font_size_prose', 'Intro/prose font size rendered'],
    [$settingsController, 'font_size_artwork_title', 'Artwork title font size rendered'],
    [$settingsController, 'font_size_artwork_meta', 'Artwork metadata font size rendered'],
    [$settingsController, 'font_size_form', 'Form font size rendered'],
    [$settingsController, 'font_size_footer', 'Footer font size rendered'],
