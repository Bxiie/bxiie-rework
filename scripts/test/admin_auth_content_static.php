...
$checks = [
    ...
    'public forgot route' => [$root . '/public/index.php', "\$router->get('/password/forgot'"],
    'public reset route' => [$root . '/public/index.php', "\$router->get('/password/reset'"],
    'artwork placement route' => [$root . '/public/index.php', '/admin/artworks/placement'],
