...
$checks = [
    ...
    'app/Http/Controllers/Tenant/Admin/ArtworkBulkUploadController.php' => ['webkitdirectory', 'artworks.csv', 'Download sample spreadsheet', 'filename,title,artwork_date', 'ArtworkUploadService', 'image filename is already used by another row', 'use either publish_at or release_group', 'requestExceededPostLimit($request)', "Response::error(413", "ini_get('post_max_size')"],
