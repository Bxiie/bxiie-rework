...
$checks = [
    ...
    'app/Http/Controllers/Tenant/SocialFrontController.php' => [
        ...
        "\$awaitingConfirmation ? 'confirmation pending'",
        "if (\$remoteId === '' && in_array((string) \$post['status']",
        'Instagram accepted the publication request. ArtsFolio is retrying confirmation:',
