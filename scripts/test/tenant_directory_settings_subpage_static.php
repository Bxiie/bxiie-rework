...
$checks = [
    ...
    [$settingsController, "if (in_array(\$key, [", 'Checkbox save handling block'],
    [$settingsController, "'platform_directory_opt_in',", 'Directory checkbox save handling'],
    [$settingsController, "'watermark_enabled',", 'Watermark checkbox save handling'],
